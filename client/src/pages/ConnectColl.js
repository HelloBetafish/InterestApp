...
<div className="cd-fixed-bg cd-bg-1">
  <section id="services">
    <div className="container">
      <h1 id="titleconnections" className="bounceInUp">Connect or Collaborate</h1> 
      <div className="row">
        <div className="container">
          <div className="col-sm-4"></div>
          <div className="col-sm-4">
            <div className="row">
              <div id="buttons" className="col-sm-12">
                ...
                <div className="col-sm-12">
                  ...
                  <div id="people" className="col-md-3 zoom">
                    <div className="img-thumbnail">
                      ...
                      <div className="people">
                        <p id="texta">TJ</p> 
                        <p id="textb">Web Developer <br/> Front and Back end <br/> ICE CREAM APPLICATION </p>
                      </div>   
                    </div>
                  </div>
